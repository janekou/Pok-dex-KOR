...
def main():
	print getADS('1')
	print getADS('3')
	with codecs.open('/Users/YongHui/git/Pok-dex-KOR/pokemon_KR2.csv','r', 'utf-8') as csvinput:
	    with open('/Users/YongHui/git/Pok-dex-KOR/pokemon_KR3.csv', 'w') as csvoutput:
